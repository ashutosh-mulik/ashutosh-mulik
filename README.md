...
<p align="center"><i>Co-Founder & CTO @ Shutter Cloud Technologies Pvt. Ltd. </i></p>
...
At Shutter Cloud Technologies, I'm creating the Swiss Army knife for photographers - except ours doesn't get stuck in your pocket and actually helps you make money! My tech stack enables:

- ☁️ **Infinite Storage** - Cloud systems that happily swallow enormous RAW files
- 🔍 **Smart Search** - Face recognition that finds "Uncle Bob" in seconds
- 🚀 **Lightning Delivery** - Share albums faster than you can say "cheese"
- 🔐 **Blockchain Security** - Image ownership and rights management
